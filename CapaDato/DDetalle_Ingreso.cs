...
namespace CapaDato
{
    public class DDetalle_Ingreso
    {
        ...
        public DDetalle_Ingreso(int iddetalle_ingreso, int idingreso, int idarticulo, decimal
            precio_compra, decimal precio_venta, int stock_inicial, int stock_actual, 
        ...
        public string Insertar(DDetalle_Ingreso Detalle_Ingreso, ref SqlConnection SqlCon, ref SqlTransaction SqlTra)
        {
            ...
            try {
                ...
                ParPrecio_Venta.Value = Detalle_Ingreso.Stock_Actual;
