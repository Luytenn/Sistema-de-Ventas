...
namespace capaPresentacion
{
    public partial class FrmVenta : Form
    {
            ...
            decimal precio_venta, int stock, DateTime fecha_vencimiento)
        {
            ...
            this.dtFechaVen.Value = fecha_vencimiento;  
        ...
        {
            FrmVistaArticulo_Venta frmVistaArticulo = new FrmVistaArticulo_Venta();

            frmVistaArticulo.ShowDialog();
        }

        private void BtnBuscarCliente_Click(object sender, EventArgs e)
        {
            FrmVistaCliente_Venta frmVistaCliente = new FrmVistaCliente_Venta();
