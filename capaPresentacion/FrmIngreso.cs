...
namespace capaPresentacion
{
    public partial class FrmIngreso : Form
    {
        ...
        private void BtnAnular_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult Opcion;
                Opcion = MessageBox.Show("Realmente Desea Alunar los Registros", "Sistema de Ventas", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NIngreso.Insertar(this.Idtrabajador,Convert.ToInt32(this.txtIdproveedor.Text), dtFecha.Value,
                            cbTipo_comprobante.Text, txtSerie.Text, txtCorrelativo.Text, Convert.ToDecimal(txtIgv.Text)
                            , "EMITIDO", dtDetalle);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (registrar)
                    {
                        ...
                        row["fecha_produccion"] = dtFechaPro.Value;
        ...
        private void DataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.cbTipo_comprobante.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["tipo_comprobante"]);
            this.txtIdingreso.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["idingreso"].Value);
